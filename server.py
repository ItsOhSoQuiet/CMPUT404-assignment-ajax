#!/usr/bin/env python
# coding: utf-8
# Copyright 2013, 2019 Abram Hindle, Matthew Kluk
# 
...
def hello():
    ...
    # Redirect info from: https://stackoverflow.com/questions/14343812/redirecting-to-url-in-flask
